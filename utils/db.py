...
class DatabaseConnection:
    def __init__(
        self, db_type: str = "sqlite3", db_file: str = "/tmp/drinks.db"
    ) -> None:
...
def db_factory(
    db_type: str = "sqlite3", db_file: str = "/tmp/drinks.db"
) -> DatabaseConnection:
    """Creates and returns a DatabaseConnection object.
